  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(60%_120%_at_50%_-20%,#e2efff,transparent)] dark:bg-[radial-gradient(60%_120%_at_50%_-20%,#0b1220,transparent)] transition-colors">
      ...
      <main className="max-w-5xl mx-auto px-4 py-6">
        {err && <div className="mb-4 rounded-lg bg-red-50 dark:bg-red-950 text-red-700 dark:text-red-200 px-3 py-2">{err}</div>}
        ...
        <div className="grid gap-6 lg:grid-cols-[1.2fr,1fr]">
          ...
          <section>
            ...
            {pinned.length > 0 && (
              <>
                <div className="flex items-center justify-between mb-2">
                  <h2 className="text-sm font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Pinned</h2>
                </div>
            ...
            {/* others */}
            <div className="flex items-center justify-between mb-2">
              <h2 className="text-sm font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">All Notes</h2>
